"""Contains tests for exceptions thrown in doubly_linked_list"""

import pytest

from dataStructs.doubly_linked_list import DoublyLinkedList, Node
...
def test_insert_node_after_non_node(new_list):
...
def test_delete_nonexistent_node_by_key(new_list):
...
def test_swap_nodes_with_key_1_same_as_key_2(new_list):
